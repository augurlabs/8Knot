                ...
                html.P(
                    [
                        ...
                        html.A(
                            ...
                            href="https://github.com/augurlabs/8Knot/issues/new?template=augur_load.md",
                            target="_blank",
    ...
    children=[
        dbc.NavItem(
            dbc.NavLink(
                ...
                href="https://github.com/augurlabs/8Knot/issues/new?assignees=&labels=enhancement%2Cvisualization&template=visualizations.md",
                external_link="True",
                target="_blank",
            )
        ),
        dbc.NavItem(
            dbc.NavLink(
                "Bug",
                href="https://github.com/augurlabs/8Knot/issues/new?assignees=&labels=bug&template=bug_report.md",
                external_link="True",
                target="_blank",
            )
        ),
        dbc.NavItem(
            dbc.NavLink(
                "Repo/Org Request",
                href="https://github.com/augurlabs/8Knot/issues/new?assignees=&labels=augur&template=augur_load.md",
                external_link="True",
                target="_blank",
            )
        ),
